...
This repo's code is written by following the "Animate Your Font Awesome Icons With JavaScript" youtube video tutorials which are created by Sir Brad Traversy (Youtube Channel:Traversy Media). 
